...
4.  [Understanding the Main Components](#understanding-the-main-components)
    ...
    2.  [Service Plan](#service-plan)
    3.  [Web App](#web-app)
    4.  [Storage Accounts and Containers](#storage-accounts-and-containers)
    5.  [Managed Identities and Role Assignments](#managed-identities-and-role-assignments)
    6.  [Azure Functions](#azure-functions)
    7.  [Cognitive Services](#cognitive-services)
    8.  [Cosmos DB](#cosmos-db)
    9.  [Azure Search Service](#azure-search-service)
5.  [Putting It All Together](#putting-it-all-together)
6.  [Steps to Deploy](#steps-to-deploy)
